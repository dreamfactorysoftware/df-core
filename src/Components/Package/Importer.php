...
//                        }
    ...
    protected function insertEventScripts()
    {
        try {
            ...
            if (class_exists(\DreamFactory\Core\Script\ServiceProvider::class)) throw new ForbiddenException('You need Silver license to be able to import event_scripts.');
